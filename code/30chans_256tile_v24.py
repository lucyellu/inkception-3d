...
class CFG:
    ...
    # comp_dir_path = './'
    comp_dir_path = '/content/drive/MyDrive/A_Scroll_1/modelmain/training/'
    comp_folder_name = '/content/drive/MyDrive/A_Scroll_1/modelmain/training/'
    # comp_dataset_path = f'{comp_dir_path}datasets/{comp_folder_name}/'
    comp_dataset_path = f'/content/drive/MyDrive/A_Scroll_1/modelmain/training/'
    ...
    outputs_path = f'/content/drive/MyDrive/A_Scroll_1/modelmain/training/outputs/'
...
def get_train_valid_dataset():
    ...
    # for fragment_id in ['training-1','training-2','training-3', 'valid-1']:
...
for fid in fragments:
    ...
    os.environ['WANDB_DIR'] = '/content/drive/MyDrive/A_Scroll_1/modelmain/training/outputs/'
    wandb_logger = WandbLogger(project="scroll-4-1667",name=run_slug+f'{enc}_finetune',entity='ellu')
    norm=fold==1
#   model=RegressionPLModel(enc='i3d',pred_shape=pred_shape,size=CFG.size)
#   model=RegressionPLModel.load_from_checkpoint('/valid_20230827161847_0_fr_i3depoch=7.ckpt',strict=False,enc='i3d',pred_shape=pred_shape,size=CFG.size)
#   model=RegressionPLModel.load_from_checkpoint('/content/drive/MyDrive/A_Scroll_1/modelmain/training/outputs/vesuvius-models-3/valid_valid-1_0_fr_i3depoch=11.ckpt',strict=False,enc='i3d',pred_shape=pred_shape,size=CFG.size)
    model=RegressionPLModel.load_from_checkpoint('/content/drive/MyDrive/A_Scroll_1/modelmain/training/outputs/vesuvius-models/vesuvius-3_valid-1_0_fr_i3depoch=6.ckpt',strict=False,enc='i3d',pred_shape=pred_shape,size=CFG.size)
    ...
    trainer = pl.Trainer(
        ...
        devices=1,
        logger=wandb_logger,
        default_root_dir="/content/drive/MyDrive/A_Scroll_1/modelmain/training/outputs/",
        accumulate_grad_batches=1,
        precision='16-mixed',
        gradient_clip_val=1.0,
        gradient_clip_algorithm="norm",

        callbacks=[ModelCheckpoint(filename=f'vesuvius-3_{fid}_{fold}_fr_{enc}'+'{epoch}',dirpath=CFG.model_dir,monitor='train/total_loss',mode='min',save_top_k=CFG.epochs),
