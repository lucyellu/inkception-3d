...
class InferenceArgumentParser(Tap):
    segment_id: list[str] =['20231205141500']
    segment_path:str='/content/gdrive/MyDrive/A_Scroll/inkception-3d/eval_segments_shared'
#    model_path:str='/content/drive/MyDrive/A_Scroll/inkception-3d/models/timesformer_wild15_20230702185753_0_fr_i3depoch=12.ckpt'
    model_path:str='/content/gdrive/MyDrive/A_Scroll/inkception-3d/models/timesformer_wild15_20230702185753_0_fr_i3depoch=12.ckpt'
