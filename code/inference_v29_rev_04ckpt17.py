...
class InferenceArgumentParser(Tap):
    ...
    model_path: str = '/content/drive/MyDrive/A_Scroll_1/modelmain/training/outputs/vesuvius-models/vesuvius-3_valid-1_0_fr_i3depoch=6.ckpt'
...
base_filename = f"{fragment_id}_{args.start_idx}to{args.end_idx}_stride{args.stride}_04ckpt17_reversed"
extension = 'png'
